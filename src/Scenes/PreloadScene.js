...
export default class Preload extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('spring', 'assets/bounce.png', { frameWidth: 35, frameHeight: 26, endFrame: 2 }); // 弹簧
        this.load.spritesheet('hero', 'assets/hero.png', { frameWidth: 30, frameHeight: 35, endFrame: 16 }); // 人物
