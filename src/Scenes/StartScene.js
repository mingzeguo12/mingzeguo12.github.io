export default class Start extends Phaser.Scene {
    ...
    create() {
        ...
        this.vectory_music = this.sound.add('vectory_music', { volume: 1, loop: false });
        ...
        this.timeEvent = this.time.addEvent({
            ...
            callback: function () {
                ...
                window.GameTime = minutes + ':' + seconds;
            },
            callbackScope: this,
            loop: true
        });
        ...
        // create exit door
        this.destination_door = this.add.sprite(3955, 497, 'door');
